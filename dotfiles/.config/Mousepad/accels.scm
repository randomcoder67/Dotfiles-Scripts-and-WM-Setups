...
(gtk_accel_path "<Actions>/win.file.detach-tab" "<Primary><Shift>d")
...
(gtk_accel_path "<Actions>/win.edit.convert.strip-trailing-spaces" "<Primary><Shift>t")
...
(gtk_accel_path "<Actions>/win.edit.delete-line" "<Primary>k")
